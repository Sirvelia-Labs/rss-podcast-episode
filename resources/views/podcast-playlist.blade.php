<div class="pb-shadow-[0_0px_60px_-15px_rgba(0,0,0,0.3)] pb-rounded-lg" x-cloak x-data="{ showMoreItem: null, selectedItem: 0, playedItem: null, items: @js($feed) }">
    <div>
        <p>Hola</p>
    </div>
    <div class="pb-w-full pb-max-h-[700px] pb-overflow-y-scroll podcast-scrollbar pb-gap-y-4 pb-flex pb-flex-col pb-p-6">
