...
<div class="rpe-last-container pb-grid pb-grid-cols-5 lg:pb-h-40 lg:pb-pb-0 pb-pb-3 pb-shadow-[0_0px_60px_-15px_rgba(0,0,0,0.3)] pb-rounded-lg pb-overflow-hidden"
    x-cloak x-data="singleAudioData(@js($episode))">

    <img x-bind:src="item.image" class="rpe-current-img pb-object-cover pb-h-40 pb-hidden lg:pb-inline">
        ...
        <div class="pb-flex-1 pb-px-4 pb-py-2">
            <div class="pb-grid pb-grid-cols-4">
                <div class="pb-col-span-4 lg:pb-col-span-3 pb-flex pb-flex-col pb-gap-y-2">
                    <p class="rpe-current-episode-title pb-text-lg lg:pb-text-2xl pb-font-bold pb-text-black pb-line-clamp-1" x-text="item.title">
                    </p>
                    <div class="rpe-current-subtitle pb-flex pb-text-sm lg:pb-text-base">
                        <p class="rpe-current-podcast-title">{!! esc_html($title) !!}</p>
                        <span>&nbsp; • &nbsp;</span>
                        <p class="rpe-current-pubdate pb-whitespace-nowrap" x-text="item.pubDate"></p>
                    </div>
